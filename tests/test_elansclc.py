...
LOC_PATIENTS = load_patient_cases(ROOT / "demo/patients/elansclc/locoregional_staging.json")
...
RESECTABLE_PATIENTS = load_patient_cases(
    ROOT / "demo/patients/elansclc/resectable.json"
)
...
SYSTEMIC_PATIENTS = load_patient_cases(
    ROOT / "demo/patients/elansclc/systemic_treatment.json"
)
